                            ...
                            <div class="sliderContent">
                                <div class="slider-wrapper">
                                    <div id="slider1Nivo" class="nivoSlider">
                                        <div class="slider1Frame"> <img src="<?php print blogdrupal_root_template() ?>/img/content/slider_small_01.jpg" alt=""> </div>
                                        <div class="slider1Frame"> <img src="<?php print blogdrupal_root_template() ?>/img/content/slider_small_02.jpg" alt=""> </div>
                                        <div class="slider1Frame"> <img src="<?php print blogdrupal_root_template() ?>/img/content/slider_small_03.jpg" alt=""> </div>
                                        <div class="slider1Frame"> <img src="<?php print blogdrupal_root_template() ?>/img/content/slider_small_04.jpg" alt=""> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
